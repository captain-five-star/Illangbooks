  ...
  const CardData = [
    {
      ...
      desc: `[문의 전 체크리스트]를 통해 출간 목적, 원고 준비 상태, 협업에 대한 기준 등 전반적인 사항을 고객님이 1차적으로 반드시 점검해 주셔야 합니다.`,
    },
    {
      title: `STEP 2. 원고 일부 전송 및 견적`,
      desc: `원고와 함께 견적 문의를 주시면 기재하신 사항을 바탕으로 견적을 제공합니다.
*견적 산정을 위한 원고 검토는 작업 가능 여부 판단과 비용 산정을 위한 범위로 제한되며, 원고의 방향성 설정, 제작 사양 제안 등 기획·편집·제작 컨설팅은 포함되지 않습니다.`,
    },
    {
...
*잔금 입금 완료 후 최종 파일을 전달드립니다.`,
    },
    {
      title: `STEP 5. 제작 사양 확정 및 인쇄 진행(인쇄 선택 시)`,
      desc: `이 단계는 인쇄 포함 의뢰에 한해 진행됩니다. 원고 특성과 사용 목적, 제작 부수를 고려하여 제작 사양을 검토하고, 필요 이상의 사양으로 제작비가 과도하게 발생하지 않도록 인쇄 사양을 조율합니다. 이를 바탕으로 인쇄소 견적 대행 및 일정 조율을 진행하며, 해당 작업물과 고객님의 목적에 가장 합리적인 방안을 함께 결정합니다. 인쇄비는 실비 기준(일정 수수료 포함)으로 안내되며, 제작 사양 확정 전에는 대략적인 비용 범위만 안내될 수 있습니다.
*인쇄 비용은 선입금으로 진행합니다.`,
    },
  ];
  return (
    <div className="framer-j9mvpp" data-framer-name="섹션4: 출간과정">
      <div className="framer-7ki120">
        <div className="framer-fxsh2j">
          <TitleCol title="Publishing Process" isMobile={isMobile} />
          <motion.div
            initial={{
              opacity: 0,
              x: isMobile ? 0 : 30,
