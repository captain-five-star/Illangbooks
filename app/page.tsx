                            ...
                            <div className="framer-8t6dis">
                              ...
                              <div className="framer-1ov82ka">
                                ...
                                >
                                  ...
                                  >
                                    1인 출판사, 기관, 광고 대행사 등 모든
                                    회사들과 함께합니다. 도서 장르, 출간 계획,
                                    업무 범위 등 원하시는 조건에 맞추어 서비스를
                                    제공합니다.
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="framer-awg93p">
                          ...
                          >
                            <div className="framer-8t6dis">
                              ...
                              >
                                <p className="framer-text framer-styles-preset-xvtrjt">
                                  -소장용 또는 비매품 도서를 주 대상으로 합니다
                                  (ISBN 발급 불가).
                                </p>
                                <p className="framer-text framer-styles-preset-xvtrjt">
                                  -사업자등록이 되어 있으신 분은 ISBN 발급이
                                  가능하나, 서점 유통 및 판매는 대행하지
                                  않습니다.
                                </p>
                                <p className="framer-text framer-styles-preset-xvtrjt">
                                  <br className="framer-text trailing-break" />
                        ...
                        <div className="framer-t8650y">
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                견적 문의 내용을 바탕으로 상담을 진행합니다.
                                견적 문의와 함께 원고의 일부를 미리 전송해
                                주셔야 정확한 상담이 가능합니다. (
                                <a
                        ...
                        <div className="framer-9i6ccw">
                          ...
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                -작성을 완료한 계약서는 저자님과 일랑북스가
                                1부씩 보관합니다. 계약 체결 후 저자님은 약정
                                금액을 송금 후, 완전 완고를 이메일로 전송합니다.
                              </p>
                            </div>
                          </div>
                          <div className="ssr-variant hidden-72rtr7">
                        ...
                        <div className="framer-84i4vp">
                          ...
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                -교재나 실용서의 경우 타 분야의 도서에 비해
                                사용하는 서체의 종류가 많기 때문에 경력이 많은
                                조판 작업자가 반드시 필요합니다. 일랑북스는
                                도서의 종류에 따라 해당 도서의 경험이 많은 전문
                                조판자를 배정하여 작업을 진행합니다.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="framer-58xirx">
                          ...
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                -저자님께는 2교 교정지를 pdf 파일로 보내
                                드립니다. 편집자가 요구하는 기간 내에 확인하신
                                후 수정 사항을 pdf 교정지에 직접 기재하시거나
                                워드/한글 파일에 정리하여 주시면 2교 수정 시
                                모두 반영합니다.
                              </p>
                              <p
                                className="framer-text"
                              ...
                              >
                                -교정 단계 중 담당 편집자가 저자님이 별도로
                                준비하실 자료(머리말, 작가 이력 등)를
                                요청합니다.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                ...
                                시안 2종의 PDF 파일을 저자님께 전송하면, 그중
                                1종을 선택하시어 추가 수정을 통해 완성도를 높여
                                나갑니다.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="framer-fz1nhy">
                          ...
                          <div className="ssr-variant hidden-xpwx9r">
                            ...
                            >
                              ...
                              >
                                -제작은 일반적으로 평일 기준 7일 정도 소요되며
                                제작 사양에 따라 기간은 변동될 수 있습니다. 인쇄
                                발주 전에 잔금을 송금하시면 제작 완료 후
                                계약서에 기재된 주소로 도서를 발송합니다.
                              </p>
                            </div>
                          </div>
                          <div className="ssr-variant hidden-72rtr7">
                ...
                <div className="framer-1kq9tof">
                  ...
                  <div className="ssr-variant hidden-1vk2m8p hidden-xpwx9r">
                    ...
                    >
                      ...
                      >
                        도서 장르, 제목, 원고 (예상) 분량, 원고 완성도, 원고
                        구성 요소(EX: 텍스트, 사진, 삽화, 도표, 음원 유무 및
                        대략의 개수) 필수 기재
                      </p>
                      <p
                        className="framer-text"
                      ...
                      >
                        코칭 목적 (EX: 개인 소장용 도서 출간, 출판사 투고 및
                        계약 관련, 출판사 취업(창업) 준비 등) 필수 기재
                      </p>
                    </div>
                  </div>
                  <div className="ssr-variant hidden-xpwx9r hidden-72rtr7">
