...
const FramerComponent = () => {
  useEffect(() => {
    // setIsClient(true);
    const __framer__appearAnimationsContent = {
      '11ghnnt': {
        default: {
          initial: {
            opacity: 0.001,
    ...
    const __framer__breakpoints = [
      { hash: '1vk2m8p', mediaQuery: '(min-width: 1200px)' },
      {
        hash: 'xpwx9r',
        mediaQuery: '(min-width: 810px) and (max-width: 1199.98px)',
      },
      { hash: '72rtr7', mediaQuery: '(max-width: 809.98px)' },
    ];
            ...
            animator.animateAppearEffects(
              ...
              m &&
                window.matchMedia('(prefers-reduced-motion:reduce)').matches ===
                  !0,
              animator.getActiveVariantHash(__framer__breakpoints)
            ));
