...
const FramerComponent = () => {
    return useEffect(() => {
        // setIsClient(true);
        window.__framer__appearAnimationsContent = { "11ghnnt": { "default": { "initial": { "opacity": 0.001, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "x": 0, "y": 0 }, "animate": { "opacity": 1, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "transition": { "delay": 0, "duration": 0.4, "ease": [0.44, 0, 0.56, 1], "type": "tween" }, "x": 0, "y": 0 } }, "1vk2m8p": { "initial": { "opacity": 0.001, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "x": 0, "y": 0 }, "animate": { "opacity": 1, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "transition": { "delay": 0, "duration": 0.4, "ease": [0.44, 0, 0.56, 1], "type": "tween" }, "x": 0, "y": 0 } }, "xpwx9r": { "initial": { "opacity": 0.001, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "x": 0, "y": 0 }, "animate": { "opacity": 1, "rotate": 0, "rotateX": 0, "rotateY": 0, "scale": 1, "skewX": 0, "skewY": 0, "transition": { "delay": 0, "duration": 0.4, "ease": [0.44, 0, 0.56, 1], "type": "tween" }, "x": 0, "y": 0 } } } };
        window.__framer__breakpoints = [{ "hash": "1vk2m8p", "mediaQuery": "(min-width: 1200px)" }, { "hash": "xpwx9r", "mediaQuery": "(min-width: 810px) and (max-width: 1199.98px)" }, { "hash": "72rtr7", "mediaQuery": "(max-width: 809.98px)" }];
        ...
        var animator = (() => {
            ...
            function fe({
                ...
                let f = 5 / e,
                    a = Ce(s, n, f);
                if (((e = w(e)), isNaN(a)))
                    return { stiffness: l.stiffness, damping: l.damping, duration: e };
                {
                ...
                if (!ce(e, Ke) && ce(e, Ie))
                    if (e.visualDuration) {
                        let r = e.visualDuration,
                            o = (2 * Math.PI) / (r * 1.2),
                            s = o * o,
                            n = 2 * k(0.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(s);
                        t = { ...t, mass: l.mass, stiffness: s, damping: n };
                    } else {
                        let r = fe(e);
                        ((t = { ...t, ...r, mass: l.mass }),
                ...
                if (y < 1) {
                    ...
                    b = (A) => {
                        ...
                        return (
                            i -
                            S *
                            (((g + y * T * h) / x) * Math.sin(x * A) + h * Math.cos(x * A))
                        );
                    };
                } else if (y === 1)
                    b = (x) => i - Math.exp(-T * x) * (h + (g + T * h) * x);
                else {
                    ...
                    b = (A) => {
                        ...
                        return (
                            i -
                            (S * ((g + y * T * h) * Math.sinh(G) + x * h * Math.cosh(G))) / x
                        );
                    };
                }
                let V = {
            ...
            function te(e, t, r) {
                ...
                return (
                    (n.onfinish = f),
                    i === null || window.MotionHandoffIsComplete?.(e) ? (f(), null) : i
                );
            }
            var N,
                C,
            ...
            function oe(e, t, r, o, s) {
                ...
                let i = P(n, t);
                C ||
                    ((C = R(e, t, [r[0], r[0]], { duration: 1e4, ease: 'linear' })),
                        M.set(i, { animation: C, startTime: null }),
                        (window.MotionHandoffAnimation = te),
                        ...
                        (window.MotionCancelOptimisedAnimation = (a, m, p, c) => {
                            ...
                            d &&
                                (p && c === void 0
                                    ...
                                    : d.animation.cancel(),
                                    p && c
                                        ? (re.add(d), p.render(Ge))
                                        : (M.delete(u),
                                            M.size || (window.MotionCancelOptimisedAnimation = void 0)));
                        }),
                        (window.MotionCheckAppearSync = (a, m, p) => {
                            ...
                            let g = p.on('change', (y) => {
                                d.get() !== y &&
                                    (window.MotionCancelOptimisedAnimation?.(c, m), g());
                            });
                            return g;
                        }));
                let f = () => {
                    ...
                    (N === void 0 && (N = performance.now()),
                        (a.startTime = N),
                        M.set(i, { animation: a, startTime: N }),
                        s && s(a));
                };
            ...
            function Re(e, t, r) {
                ...
                for (let i of ae(e, t)) {
                    ...
                    if (
                        f === void 0 ||
                        a === void 0 ||
                        (i !== 'transformPerspective' && f === a && f === K[i])
                    )
                        continue;
            ...
            function Ne(e, t, r, o, s) {
                ...
                if (!a) return n;
                let m = { ease: 'linear', duration: f, delay: r.delay },
                    p = s ? Se : m,
                    c = {};
                ...
                let u = De(c, o);
                return (u && (n.transform = { keyframes: u, options: p }), n);
            }
            function Fe(e) {
                let { type: t, duration: r, ...o } = e;
                return { duration: I(r), ...o };
            }
            function We(e, t, r, o, s) {
                ...
                let m = De(a, o);
                return (m && (i.transform = { keyframes: m, options: f }), i);
            }
            ...
            function Ye(e, t, r) {
                return we(r)
                    ? `${e}-${t}-${r.duration}-${r.bounce}`
                    : `${e}-${t}-${r.damping}-${r.stiffness}-${r.mass}`;
            }
            function qe(e) {
                return we(e) ? { ...e, duration: I(e.duration) } : e;
            }
            var Me = new Map(),
                be = 10;
            function Ze(e, t, r) {
                ...
                if (s) return s;
                let n = [e, t],
                    i = D({ ...qe(r), keyframes: n }),
                    f = { done: !1, value: n[0] },
                    a = [],
                    m = 0;
                for (; !f.done && m < I(10);)
                    ((f = i.next(m)), a.push(f.value), (m += be));
                n = a;
                let p = m - be,
                    u = { keyframes: n, duration: p, ease: 'linear' };
                return (Me.set(o, u), u);
            }
            function De(e, t) {
                let r = [],
                ...
                for (let n = 0; n < o; n++) {
                    ...
                    let f = Te({ transform: i, transformKeys: s }, t);
                    r.push(f);
                }
                return r;
            }
            ...
            function Oe(e, t, r, o, s, n) {
                for (let [i, f] of Object.entries(e)) {
                    ...
                    let h = {},
                        T = {};
                    for (let [b, V] of Object.entries(y))
                        ((h[b] = V.keyframes), (T[b] = V.options));
            ...
            function Ve(e) {
                return e
                    ? e.find((r) =>
                        r.mediaQuery ? window.matchMedia(r.mediaQuery).matches === !0 : !1
                    )?.hash
                    : void 0;
            }
            var Lr = {
